<?php
    ...
    <head>
        ...
        <script type="text/javascript">
                ...
                var UnitCost_Berdasarkan_Region=[];
                UnitCost_Berdasarkan_Region['dataStr'] = '<?php echo $UnitCost_Berdasarkan_Region;?>';        
                UnitCost_Berdasarkan_Region['dataArray'] = JSON.parse(UnitCost_Berdasarkan_Region['dataStr']);
                ...
                google.charts.setOnLoadCallback(function(){
                    ...
                    drawChart(UnitCost_Berdasarkan_Region['dataArray'],'bar','UnitCost_Berdasarkan_Region');
        ...
        <body>
            ...
            <div class="uk-container">
                <div class="uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">    
                    ...
                    <div>
                        <div class="uk-card uk-card-default uk-card-small uk-card-body" uk-scrollspy="cls: uk-animation-slide-left; repeat: true" >
                            <h3 class="uk-card-title">UnitCost Berdasarkan Region</h3>
                            <div id="UnitCost_Berdasarkan_Region" style="height:350px;"></div>
                        </div>
                    </div>
                    <div>
                        <div class="uk-card uk-card-default uk-card-small uk-card-body" uk-scrollspy="cls: uk-animation-slide-right; repeat: true" >
